...
public class DeployablePlayerKickedOutOfShieldEvent extends MyEvent {
    ...
    public DeployablePlayerKickedOutOfShieldEvent(BaseDeployable deployable, Player player) {
