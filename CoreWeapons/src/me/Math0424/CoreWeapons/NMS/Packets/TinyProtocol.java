package me.Math0424.CoreWeapons.NMS.Packets;
...
public abstract class TinyProtocol {
    ...
    private static final Reflection.FieldAccessor<PlayerConnection> getConnection = Reflection.getField(EntityPlayer.class, PlayerConnection.class, 0);
    private static final Reflection.FieldAccessor<NetworkManager> getManager = Reflection.getField(PlayerConnection.class, NetworkManager.class, 0);
    private static final Reflection.FieldAccessor<Channel> getChannel = Reflection.getField(NetworkManager.class, Channel.class, 0);

    // Looking up ServerConnection
    private static final Reflection.FieldAccessor<MinecraftServer> getMinecraftServer = Reflection.getField("{obc}.CraftServer", MinecraftServer.class, 0);
    private static final Reflection.FieldAccessor<ServerConnection> getServerConnection = Reflection.getField(MinecraftServer.class, ServerConnection.class, 0);

    //Get the server connection manager
    private static final Reflection.FieldAccessor<List> getNetworkManagers = Reflection.getField(ServerConnection.class, List.class, 1);

    // Packets we have to intercept
    private static final Reflection.FieldAccessor<GameProfile> getGameProfile = Reflection.getField(PacketLoginInStart.class, GameProfile.class, 0);
    ...
    private void registerChannelHandler() {
        ...
        networkManagers = getNetworkManagers.get(serverConnection);
    ...
    private PacketInterceptor injectChannelInternal(Channel channel) {
        try {
            ...
            try {
                interceptor = (PacketInterceptor) channel.pipeline().get(handlerName);
            } catch (Exception e) {
                interceptor = null;
            }
